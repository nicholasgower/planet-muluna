local x_offset = 15
local y_offset = -45
local x_offset_engine = 0
local y_offset_engine = -15
local function rocket_silo_crafting_pictures()
  return
  {
    ...
    animation =
    {
      ...
      scale = 0.5,
      shift = util.by_pixel( 83.0+x_offset, 82.0+y_offset)
    },
    name = "crafting"
  }
end
...
local function rocket_silo_light_pictures()
  return
  {
    ...
    animation =
    {
      ...
      blend_mode = "additive",
      frame_count = 64,
      shift = util.by_pixel( 80.0+x_offset, 82.0+y_offset),
      line_length = 6,
      animation_speed = 0.65,
      scale = 0.5
    }
...
local function rocket_silo_filter_pictures()
  return
  {
    ...
    animation =
    {
      ...
      animation_speed = 0.65,
      scale = 0.5,
      shift = util.by_pixel( -92.5+x_offset, -69.0+y_offset)
    }
  }
end
...
local function rocket_silo_engine_pictures()
  return
  {
    ...
    animation =
    {
      ...
      height = 152,
      frame_count = 32,
      shift = util.by_pixel( -89.0+x_offset_engine, -104.0+y_offset_engine),
      line_length = 6,
      animation_speed = 0.65,
      scale = 0.5
...
local function rocket_silo_steam_1()
  return
  {
    ...
    animation =
    {
      ...
      height = 178,
      animation_speed = 0.3,
      shift = util.by_pixel( 3.0+x_offset, 93.0+y_offset),
...
local function rocket_silo_steam_2()
  return
  {
    ...
    animation =
    {
      ...
      height =  164,
      animation_speed = 0.3,
      shift = util.by_pixel(146.0+x_offset, 71.0+y_offset),
      tint = {0.7, 0.7, 0.7, 0.5},
      scale = 0.5,
      allow_forced_downscale = true
    }
