            ...
            if prototype.data_capacity ~= nil then
                ...
                local recipe = {
                    ...
                    ingredients = { 
                        ...
                        {type = "fluid", name = "muluna-astronomical-data", amount = prototype.data_capacity, fluidbox_index = 12,ignored_by_stats = prototype.data_capacity,ignored_by_productivity=prototype.data_capacity},
                    },
                    results = {{type = "item" , name = data_cell.name, amount = 1, fluidbox_index = 12,ignored_by_stats = 1,ignored_by_productivity=1}},
