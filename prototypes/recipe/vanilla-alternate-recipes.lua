...
landfill_crushed_stone.ingredients = {{type = "item",name = "stone-crushed",amount = math.ceil(30/50*stone_cost)},{type = "item",name = "concrete",amount = math.ceil(5/50*stone_cost)}}
